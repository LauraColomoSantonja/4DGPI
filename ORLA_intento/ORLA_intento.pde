...
void setup() {
  size(780, 700);
  mifuente=loadFont("FiraSans-Medium-48.vlw");
}
void draw() { 
  if (record==true) {
    beginRecord(PDF, "retratosorla#.pdf");
  }

  background(200);

  float rx=random(100, 200);
  float rx1=random(60, 150);
  float rx2=random(70, 100);
  float rx3=random(20, 90);
  float rx4=random(300, 50);

  float ry=random(20, 80);
  float ry1=random(50, 200);
  float ry2=random(120, 180);
  float ry3=random(90, 100);
  float ry4=random(12, 80);
  ...
  /*quitar
   ...
   rect (30, 250, 150, 200);
   rect (220, 250, 150, 200);
   rect (410, 250, 150, 200);
   rect (600, 250, 150, 200);
   
   rect (30, 480, 150, 200);
   rect (220, 480, 150, 200);
...
void jorge(float x, float y) {
  ...
  textSize(70);
  fill(#030202);
  text("DISEÑO GRÁFICO", 450, 200);
 

  //AÑO 
  textSize(40);
  text("Curso 2019/2020", 450, 247);
